// Generated from C:/Projects/Jungle_Week14_Team4/KraftonEngine/Content/Material/Particle/DefaultParticle.uasset
...
{
    float4 n_23 = Tex_Diffuse.Sample(LinearWrapSampler, Input.UV0);
    float4 n_46 = Input.VertexColor;
    float3 n_40 = ((n_23).rgb * (n_46).rgb);
    float3 n_56 = (n_40 * float3((n_46).a, (n_46).a, (n_46).a));
